...
function doFun(){
 tColorA.style.color = "orange";
 tColorB.style.color = "#444";
 tColorC.style.color = "#444";
 iconA.style.color = "orange";
...
function doFunA(){
 ...
 tColorB.style.color = "orange";
 tColorC.style.color = "#444";
 iconA.style.color = "#aaa";
 iconB.style.color = "orange";
 iconC.style.color = "#aaa";
...
cvv.addEventListener('keyup', function(e){
 ...
 if(elen.length<3){
  ...
  cvvBox.style.border="1px solid orange";
 }
})
